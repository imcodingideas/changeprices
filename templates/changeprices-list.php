<link type="text/css" href="<?php echo WP_PLUGIN_URL; ?>/changeprice/style-admin.css" rel="stylesheet" />
<div class="wrap">
...
<?php foreach ($terms as $t): ?>
		<option value="<?php echo $t->term_id; ?>" <?php if(isset($_GET['term-id']) && $_GET['term-id'] ==$t->term_id) echo "selected"; ?>>
			<?php echo $t->name; ?>
		</option>
<?php endforeach?>
	</select>
...
<?php if (count($products)): ?>
	...
	<h3>Total: <?php echo count($products) ?> product variations for <?php echo $term->name ?></h3>
	...
	<table class="widefat striped">
		...
		<tr>			
			...
			<td>
				<a href="<?php echo $product['parent_permalink']; ?>" target="_blank">
					<?php echo $product['parent_title']; ?>
				</a>				
			</td>
			<td><?php echo $product['variation_id']; ?></td>
			<td><?php echo $product['variation_sku']; ?></td>
			<td>
				<?php if ($product['variation_price']): ?>
					$<?php echo $product['variation_price']; ?>
				<?php endif ?>
			</td>
			<td>
				<?php if ($product['variation_sale_price']): ?>
					$<?php echo $product['variation_sale_price']; ?>
				<?php endif ?>
			</td>
			<td>
				<a href="<?php echo $product['parent_edit_post_link']; ?>" target="_blank">
					Edit
				</a>
			</td>
		</tr>
